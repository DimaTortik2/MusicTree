  ...
  useEffect(() => {
    ...
    const initFetch = async () => {
      ...
      if (data && data.progress_state) {
        ...
        const mergedState = {
          // 🔥 ИСПРАВЛЕНИЕ: затираем возможный мусор
          passedLessons: [],
          passedHomeworks: [],
          passedTests: {},
          halfPassedLessons: {},
        ...
        lastSavedState.current = JSON.stringify(
          stripNav(useSharedProgressStore.getState()),
        );
      }
